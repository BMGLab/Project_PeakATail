...
counts, the cluster's own 16 bp extent (bracket; the 25 bp parameter bounds the
...
null 0.0217. The BED row counts are 7–64 above the scored n because the scorer drops
