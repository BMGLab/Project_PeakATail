# Fig S7 — `figS7_novelfunnel` caption (generated by `scripts/manuscript_figures/figS7_novelfunnel.py`; renamed 2026-09-02, see FIGURE_MAP.tsv — demoted from 21's main Fig 6 slot, prominence kept in R6/abstract/Author Summary)
