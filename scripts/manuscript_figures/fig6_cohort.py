#!/usr/bin/env python3
"""
fig6_cohort.py -- manuscript Fig 6 ("fig6_cohort"): reliable
...
is plotted.  Same registry pattern as scripts/manuscript_figures/fig2_accuracy.py.
...
Run:  export LC_ALL=C; python3 scripts/manuscript_figures/fig6_cohort.py
      export LC_ALL=C; LAUGHNEY_SWITCHES_VERSION=v1_code python3 .../fig6_cohort.py
"""
import collections
import json
import os
